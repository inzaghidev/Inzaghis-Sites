...
import InzaghisDev from "../pages/inzaghis-group/InzaghisDev.jsx";
import InzaghisArchives from "../pages/inzaghis-group/InzaghisArchives.jsx";
import InzaghisApp from "../pages/inzaghis-group/InzaghisApp.jsx";
import InzaghisAI from "../pages/inzaghis-group/InzaghisAI.jsx";
...
function CalculatorTool() {
  return (
    <div className="max-w-xl mx-auto space-y-4 bg-slate-50 border border-slate-100 rounded-2xl p-6 text-center">
      ...
      <p className="text-xs text-slate-500 leading-relaxed">
        Kalkulator serbaguna untuk matematika, keuangan, dan sains — segera
        hadir!
      </p>
      <span className="inline-block text-[10px] bg-amber-100 text-amber-700 px-3 py-1 rounded-full font-bold uppercase">
        Coming Soon
...
function WidgetPortal() {
  return (
    <div className="max-w-xl mx-auto space-y-4 bg-slate-50 border border-slate-100 rounded-2xl p-6 text-center">
      ...
      <p className="text-xs text-slate-500 leading-relaxed">
        Koleksi widget interaktif — jam, cuaca, catatan, dan alat produktivitas
        lainnya.
      </p>
    ...
    <BrowserRouter>
      <Layout>
        <Routes>
          ...
          />
          <Route
            path="/inzaghis-group/inzaghis-dev"
            element={<InzaghisDev />}
          />
          <Route
            path="/inzaghis-group/inzaghis-archives"
            element={<InzaghisArchives />}
          />
          <Route
            path="/inzaghis-group/inzaghis-app"
            element={<InzaghisApp />}
          />
          <Route path="/inzaghis-group/inzaghis-ai" element={<InzaghisAI />} />
      ...
      <section key="apps-view" id="apps-view-container" className="space-y-8">
        ...
        <div className="text-left space-y-2">
          ...
          <p className="text-xs md:text-sm text-slate-500 max-w-3xl leading-relaxed font-normal">
            ...
            kebutuhan. Pages Apps menyediakan berbagai Portal seperti
          ...
          <div className="bg-white border border-slate-200/60 rounded-3xl p-6 md:p-8 shadow-sm">
            ...
            {portalId === "materials" && (
              <div className="max-w-xl mx-auto space-y-4 bg-slate-50 border border-slate-100 rounded-2xl p-6 text-center">
                ...
                <p className="text-xs text-slate-500 leading-relaxed max-w-sm mx-auto">
                  Akses modul kuliah TI, draf tugas akhir, panduan instalasi
                  Linux server, serta hasil wawancara riset AI secara gratis.
                </p>
                <button
                  onClick={() =>
            ...
            {portalId === "projects" && (
              <div className="max-w-xl mx-auto space-y-4 bg-slate-50 border border-slate-100 rounded-2xl p-6 text-center">
                ...
                <p className="text-xs text-slate-500 leading-relaxed max-w-sm mx-auto">
                  Lihat daftar lengkap repositori GitHub yang diproduksi oleh
                  tim InzaTech, dari microservices hingga sensor IoT cerdas.
                </p>
                <a
