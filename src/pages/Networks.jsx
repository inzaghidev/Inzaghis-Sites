...
export default function Networks() {
  return (
    <>
      ...
      <section className="about-us">
        <section className="about-us-container">
          <div className="about-us-title">
            <h1 className="about-us-title">OUR NETWORKS</h1>
          </div>
          <div className="about-us-wrapper">
            <div className="about-us-to-inzaghis-group">
      ...
      <section className="inzaghis-blog">
        <div className="inzaghisblog-container">
          ...
          <div className="container inzaghisblog mx-auto">
            <div className="flex flex-wrap mx-0 md:-mx-4 xl:-mx-2">
      ...
      <section className="inzaghis-media">
        <div className="inzaghis-media-container">
          <section className="group-wrapper">
            <section className="group-content reverse-content">
              ...
              <section className="inzaghismedia-description">
                <h2 className="group-title">Inzaghi's Media</h2>
                <p className="left-subheading mt-3">
      ...
      <section className="inzaghis-dev">
        <section className="group-wrapper">
          <section className="group-content">
            <section className="group-image">
              <img
            ...
            <section className="content-description">
              <h2 className="group-title">Inzaghi's Dev</h2>
              <p className="left-subheading mt-3">
      ...
      <section className="inzaghis-app">
        <section className="group-wrapper">
          <section className="group-content reverse-content">
            <section className="group-image">
              <img
      ...
      <section className="inzaghis-archives">
        <section className="group-wrapper">
          <section className="group-content">
            <section className="group-image">
              <img
            ...
            <section className="content-description">
              <h2 className="group-title">Inzaghi's Archives</h2>
              <p className="left-subheading mt-3">
      ...
      <section className="inzaghis-ai">
        <section className="group-wrapper">
          <section className="group-content reverse-content">
            ...
            <section className="content-description">
              <h2 className="group-title">Inzaghi's AI</h2>
              <p className="left-subheading mt-3">
