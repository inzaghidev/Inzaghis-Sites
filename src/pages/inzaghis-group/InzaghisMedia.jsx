      ...
      <div class="bg-white shadow-xl rounded-lg p-6 ring-1 ring-red-400 p-6">
        ...
        <div class="mb-6">
          ...
          <p class="mt-2 text-gray-600 text-sm font-[Inter]">
            Sebagai Postingan berbentuk Gambar Persegi dan sebagai Asisten dari
            Inzaghi's Blog.
          </p>
          <br />
        ...
        <div class="mb-6">
          ...
          <p class="mt-2 text-gray-600 text-sm font-[Inter]">
            Sebagai sebuah Channel yang berbentuk Video seperti Tutorial, Video
            Shorts, hingga Demo Aplikasi/Project.
          </p>
          <br />
          <div
