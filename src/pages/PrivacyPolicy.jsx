...
export default function PrivacyPolicy() {
  return (
    <>
      <Helmet>
        <title>Privacy Policy - Inzaghi's Sites</title>
      </Helmet>
          ...
          <div className="page-wrapper bg-white shadow-xl rounded-lg ring-1 ring-green-500">
            <div className="page-description font-[Inter] p-6 lg:p-12">
              <p className="is-desc text-gray-700 mb-6">
                At Inzaghi's Sites, accessible from https://inzaghi.wuaze.com,
              ...
              <p className="is-desc text-gray-700 mb-6">
                ...
                advertisements and links that appear on Inzaghi's Sites, which
                ...
                that you visit. Note that Inzaghi's Sites has no access to or
              ...
              <p className="is-desc text-gray-700 mb-6">
                ...
                activity. Inzaghi's Sites does not knowingly collect any
              ...
              <p className="is-desc text-gray-700 mb-6">
                ...
                information that they shared and/or collect in Inzaghi's Sites.
