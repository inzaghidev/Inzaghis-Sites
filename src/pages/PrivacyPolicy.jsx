        ...
        <div className="page-container page-wrapper">
          ...
          <div className="page-wrapper bg-white shadow-xl rounded-lg ring-1 ring-green-500">
            <div className="page-description font-[Inter] p-6 lg:p-12">
              ...
              <h2 className="text-3xl mb-6 font-semibold">Log Files</h2>
              ...
              <h2 className="text-3xl mb-6 font-semibold">Privacy Policies</h2>
              ...
              <p className="is-desc text-gray-700 mb-6">
                ...
                and links that appear on Inzaghi's Sites, which are sent directly
                ...
                Note that Inzaghi's Sites has no access to or control over these
                cookies that are used by third-party advertisers.
              </p>
                 
              <h2 className="text-3xl mb-6 font-semibold">Third Party Privacy Policies</h2>
              ...
              <h2 className="text-3xl mb-6 font-semibold">Children's Information</h2>
                 
              <p className="is-desc text-gray-700 mb-6">
                Another part of our priority is adding protection for children
                while using the internet. We encourage parents and guardians to
                observe, participate in, and/or monitor and guide their online
                activity. Inzaghi's Sites does not knowingly collect any Personal
              ...
              <h2 className="text-3xl mb-6 font-semibold">Online Privacy Policy Only</h2>
