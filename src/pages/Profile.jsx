export default function Profile() {
  return (
    <>
      ...
      <div className="pages-background page-sub-container-full bg-gray-100">
        <div className="container mx-auto py-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 px-4">
            <div className="col-span-4 md:col-span-8 lg:col-span-3">
              <div className="bg-white shadow-xl rounded-lg p-6 ring-1 ring-green-500">
                <div className="flex flex-col items-center">
                  ...
                  <h1 className="text-xl font-bold text-center">Inzaghi Posuma Al Kahfi</h1>
                  <p className="text-gray-700 text-center">Software Developer</p>
                  <div className="mt-6 flex flex-wrap gap-4 justify-center">
                    <a
                      href="https://inzaghiposuma.blogspot.com/p/contact-and-profile.html"
                      target="_blank"
                      rel="noreferrer"
                      className="bg-blue-500 hover:bg-blue-600 text-white hover:text-white py-2 px-4 rounded-lg focus:ring-4 focus:ring-blue-300"
                    >
                      Contact
                    </a>
                    <a
                      href="#"
                      className="bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded-lg focus:ring-4 focus:ring-gray-200"
                    >
                      Resume
                    </a>
                  </div>
                ...
                <section className="py-3">
                  <h3 className="uppercase font-semibold text-lg mb-4">Education</h3>
                  <ul className="list-none space-y-3">
                    <li>
                      <div className="font-bold text-base">Information Technology</div>
                      <div className="text-gray-500 text-sm">Pradita University</div>
                      <div className="text-gray-500 text-sm">2021 - 2025</div>
                    </li>
                    <li>
                      <div className="font-bold text-base">Science Studies</div>
                      <div className="text-gray-500 text-sm">Islamic Village High School</div>
                      <div className="text-gray-500 text-sm">2018 - 2021</div>
                    </li>
                  </ul>
                </section>
              </div>
            ...
            <div className="col-span-4 md:col-span-8 lg:col-span-9">
              <div className="font-['Inter'] bg-white shadow-xl rounded-lg p-6 ring-1 ring-green-500">
                ...
                <div className="mb-6">
                  <div className="flex justify-between flex-wrap gap-2 w-full">
                    <span className="text-gray-700 text-lg font-bold">Web Developer</span>
                    <p>
                ...
                <div className="mb-6">
                  <div className="flex justify-between flex-wrap gap-2 w-full">
                    <span className="text-gray-700 text-lg font-bold">Project Lorem Ipsum 1</span>
                    <p>
                      <span className="text-gray-700 mr-2">Open Source</span>
                    </p>
                  </div>
                  <p className="mt-2 text-sm">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                ...
                <div className="mb-6">
                  <div className="flex justify-between flex-wrap gap-2 w-full">
                    <span className="text-gray-700 text-lg font-bold">Project Lorem Ipsum 2</span>
                    <p>
                      <span className="text-gray-700 mr-2">Open Source</span>
                    </p>
                  </div>
