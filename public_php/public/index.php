      ...
      <div class="page-apps-container">
        ...
        <div class="text-container">
          <p class="text-description">
            Merupakan Halaman Aplikasi yang tersedia untuk berbagai kebutuhan.
            Pages Apps menyediakan berbagai Portal seperti Halaman, Widget,
            Konverter, dan Kalkulator.
          </p>
        ...
        <section class="group-content">
          ...
          <section class="content-description">
            ...
            <!--button type="button" class="btn btn-primary btn-md">
              <a href="../page-apps/page.php" class="blog-link">Click here</a>
            </button-->
            <button type="button" class="btn btn-primary btn-md">
