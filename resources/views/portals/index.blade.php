      ...
      $(document).ready(function () {
        ...
        const apps = [
          ...
          },
          {
            ...
            link: "../portals/career-portal.html",
          },
          {
          ...
          },
          {
            ...
            link: "../portals/entertainment-portal.html",
          },
          {
            name: "Link Pages",
          ...
          },
          {
            ...
            link: "../portals/muslim-portal.html",
          },
          {
            name: "Miscellaneous",
                  ...
                  <div class="card-body card-portals-body">
                    <div class="card-text-container card-body">
                      ...
                      <button class="btn btn-primary btn-md">
                        <a class="button-link" href="${app.link}">Click here</a>
                      </button>
                    </div>
                  </div>
                </div>
