      ...
      <section class="group-wrapper">
        <section class="group-content">
          <section class="group-image">
            <img
              src="{{URL::asset('assets/images/inzaghis-blog-by-inzaghis-group-corp.png')}}"
              alt="Inzaghi's Blog"
              style="width: 600px"
            />
          </section>
  ...
  <div class="inzaghis-media-container">
    <section class="group-wrapper">
      <section class="group-content reverse-content">
        <section class="group-image">
          <img
            src="{{URL::asset('assets/images/inzaghis-media-by-inzaghis-group-corp.png')}}"
            alt="Inzaghi's Media"
            style="width: 600px"
          />
        </section>
...
<section class="inzaghis-dev">
  <section class="group-wrapper">
    <section class="group-content">
      <section class="group-image">
        <img
          src="{{URL::asset('assets/images/inzaghis-dev-by-inzaghis-group-corp.png')}}"
          alt="Inzaghi's Dev"
          style="width: 600px"
        />
      </section>
...
<section class="inzaghis-app">
  <section class="group-wrapper">
    <section class="group-content reverse-content">
      <section class="group-image">
        <img
          src="{{URL::asset('assets/images/inzaghis-app-by-inzaghis-group-corp.png')}}"
          alt="Inzaghi's App"
          style="width: 600px"
        />
      </section>
...
<section class="inzaghis-archives">
  <section class="group-wrapper">
    <section class="group-content">
      <section class="group-image">
        <img
          src="{{URL::asset('assets/images/inzaghis-archives-by-inzaghis-group-corp.png')}}"
          alt="Inzaghi's App"
          style="width: 600px"
        />
      </section>
...
<section class="inzaghis-ai">
  <section class="group-wrapper">
    <section class="group-content reverse-content">
      <section class="group-image">
        <img
          src="{{URL::asset('assets/images/inzaghis-ai-by-inzaghis-group-corp.png')}}"
          alt="Inzaghi's App"
          style="width: 600px"
        />
      </section>
