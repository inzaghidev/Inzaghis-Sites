  ...
  <div class="grid grid-cols-4 md:grid-cols-12 gap-6 lg:px-16 xl:px-0 justify-center">
    <?php if (is_array($apps) && count($apps) > 0): ?>
      <?php foreach ($apps as $app): ?>
        ...
        ?>
        <div class="bg-gray-300 bg-opacity-20 col-span-8 sm:col-span-12 md:col-span-12 lg:col-span-6 shadow rounded-lg p-5 mx-auto">
          <div class="flex flex-col object-center bg-white border border-gray-200 rounded-lg shadow sm:flex-row lg:flex-col xl:flex-row hover:bg-gray-100 border-gray-300 bg-gray-200 hover:bg-gray-300">
            <img class="w-full rounded-t-lg h-1/4 sm:h-auto sm:w-52 lg:w-full xl:w-72 sm:rounded-l-lg sm:rounded-r-none md:rounded-s-lg lg:rounded-t-lg lg:rounded-b-none xl:rounded-r-none" src="<?php echo $imgSrc; ?>" alt="<?php echo $name; ?>">
            <div class="flex flex-col justify-between p-4 leading-normal">
              <h5 class="mb-3 text-3xl font-bold text-center md:text-left lg:text-center xl:text-left tracking-tight text-gray-900 text-black"><?php echo $name; ?></h5>
