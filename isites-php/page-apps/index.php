      ...
      <?php if (is_array($apps) && count($apps) > 0): ?>
        <?php foreach ($apps as $app): ?>
          ...
          <div class="bg-gray-300 bg-opacity-20 col-span-8 sm:col-span-12 md:col-span-12 lg:col-span-6 shadow rounded-lg p-4 mx-auto ring-1 ring-gray-200">
            <div class="flex flex-col bg-white border border-gray-200 rounded-lg shadow sm:flex-row lg:flex-col xl:flex-row hover:bg-gray-100 border-gray-300 hover:bg-gray-300 sm:h-full transition-all duration-400">
