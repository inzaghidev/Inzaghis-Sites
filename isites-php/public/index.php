      ...
      >
        <div class="flex">
          ...
          <div class="ms-4">
            ...
            <div
              class="mt-1 text-sm text-green-600 dark:text-green-700 font-[Inter]"
            >
          ...
          <div class="divide-y divide-slate-200">
            ...
            <div class="items-center justify-between pb-3 pt-3 last:pb-0">
              <div class="flex justify-between flex-wrap gap-2 mb-4 w-full">
                ...
                <div
                  x-data="{ open: false }"
                  class="relative inline-flex min-w-[100px] sm:min-w-1"
                >
                    <button
                      @click="open = !open"
                      type="button"
                      class="inline-flex items-center px-4 py-2 md:px-6 lg:py-2.5 xl:px-8 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-gray-800 hover:text-white dark:bg-blue-600 dark:hover:bg-blue-700"
                    >
                      Click here
                      <svg
                        viewBox="0 0 20 20"
                        ...
                        data-slot="icon"
                        aria-hidden="true"
                        class="-mr-1 size-4 md:size-5 text-white transition-transform duration-200"
                    ...
                    <div
                      ...
                      class="absolute left-0 sm:left-auto sm:right-0 top-full z-50 mt-1 w-48 rounded-lg bg-gray-100 shadow-xl outline outline-1 outline-black/5"
                      style="display: none"
                    >
                      <div class="py-1">
                        <a
                          href="https://inzaghi.infinityfreeapp.com"
                          class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300 hover:text-gray-900"
                          >Link</a
                        >
                        <a
              ...
              <div class="flex justify-between flex-wrap gap-2 mb-4 w-full">
                ...
                >
                    ...
                    >
                      <div class="py-1">
                        <a
                          href="https://inzaghis-sites.vercel.app"
                          class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300 hover:text-gray-900"
                          >Link</a
                        >
                        <a
