    ...
    <div class="footer-container">
        <section class="footer-wrapper mb-10">
            ...
            <section class="special-pages">
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="<?php echo $pathToWebRoot.'/portals/'; ?>" class="hover:text-blue-800">Portals</a></li>
                        <li><a href="<?php echo $pathToWebRoot.'/page-apps/'; ?>" class="hover:text-blue-800">Apps</a></li>
                        <li><a href="https://medium.com/@izzumiposhaf29" class="hover:text-blue-800" target="_blank">Blog</a></li>
            ...
            <section class="network">
                ...
                <nav>
                    <ul>
                        <li><a href="<?php echo $pathToWebRoot.'/inzaghis-group/inzaghis-blog.php'; ?>" class="hover:text-blue-800">Inzaghi's Blog</a></li>
