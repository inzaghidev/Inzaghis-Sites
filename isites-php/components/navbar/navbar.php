    ...
    <div class="container mx-auto px-4 flex items-center justify-center gap-6 w-full">
      ...
      <div id="navigation-menu" :class="open ? 'block' : 'hidden'" class="hidden lg:flex lg:flex-row flex-col items-center justify-start lg:space-x-1 pb-3 lg:pb-0">
        ...
        <div class="relative group" @mouseenter="dropdown = 'blogs'" @mouseleave="dropdown = null">
          ...
          <div x-show="dropdown === 'blogs'" x-transition="" class="nav-drpdwn-list px-2 py-2 absolute inset-auto w-48 origin-top-right rounded-lg shadow-lg bg-[#dadeda] bg-opacity-90 backdrop-filter backdrop-blur-xl dark-mode:bg-[#222522]" style="display: none;">
        ...
        <div class="relative group" @mouseenter="dropdown = 'portals'" @mouseleave="dropdown = null">
          ...
          <div x-show="dropdown === 'portals'" x-transition="" class="nav-drpdwn-list px-2 py-2 absolute inset-auto w-48 origin-top-right rounded-lg shadow-lg bg-[#dadeda] bg-opacity-90 backdrop-filter backdrop-blur-xl dark-mode:bg-[#222522]" style="display: none;">
        ...
        <div class="relative group" @mouseenter="dropdown = 'apps'" @mouseleave="dropdown = null">
          ...
          <div x-show="dropdown === 'apps'" x-transition="" class="nav-drpdwn-list px-2 py-2 absolute inset-auto w-48 origin-top-right rounded-lg shadow-lg bg-[#dadeda] bg-opacity-90 backdrop-filter backdrop-blur-xl dark-mode:bg-[#222522]" style="display: none;">
        ...
        <div class="relative group" @mouseenter="dropdown = 'about-profile'" @mouseleave="dropdown = null">
          ...
          <div x-show="dropdown === 'about-profile'" x-transition="" class="nav-drpdwn-list px-2 py-2 absolute inset-auto w-48 origin-top-right rounded-lg shadow-lg bg-[#dadeda] bg-opacity-90 backdrop-filter backdrop-blur-xl dark-mode:bg-[#222522]" style="display: none;">
        ...
        <div class="relative group" @mouseenter="dropdown = 'group'" @mouseleave="dropdown = null">
          ...
          <div x-show="dropdown === 'group'" x-transition="" class="nav-drpdwn-list px-2 py-2 absolute inset-auto w-48 origin-top-right rounded-lg shadow-lg bg-[#dadeda] bg-opacity-90 backdrop-filter backdrop-blur-xl dark-mode:bg-[#222522]" style="display: none;">
        ...
        <div class="relative group" @mouseenter="dropdown = 'switch-sites'" @mouseleave="dropdown = null">
          ...
          <div x-show="dropdown === 'switch-sites'" x-transition="" class="nav-drpdwn-list px-2 py-2 absolute inset-auto w-48 origin-top-right rounded-lg shadow-lg bg-[#dadeda] bg-opacity-90 backdrop-filter backdrop-blur-xl dark-mode:bg-[#222522]" style="display: none;">
