      ...
      <div class="flex items-center justify-between px-4 py-3 bg-gray-200">
        <span class="text-xl font-semibold text-gray-900">
          <a href="<?php echo $pathToWebRoot.'/public/index.php'; ?>" class="relative bg-gray-200 w-auto max-w-full h-full px-2 py-2">
            <img src="<?php echo $pathToWebRoot.'/assets/icons/inzaghis-sites-logo-vertical-transparent.png'; ?>" title="Inzaghi's Sites" class="h-12" id="logo" alt="Inzaghi's Sites"> </a></span>
        <div class="menu-toggle lg:hidden flex items-center hover:bg-gray-300 gap-2 rounded-lg block">
...
<!-- <div
  ...
  x-init="$watch('scrolled', (value) => {
    ...
    if (navContainer) {
      if (value) {
        // Saat discroll, berikan transparansi 60% (sesuai kebutuhan)
        navContainer.classList.add('bg-opacity-60', 'shadow-md');
        ...
        navContainer.classList.remove('bg-opacity-60', 'shadow-md');
      }
    }
  })"
