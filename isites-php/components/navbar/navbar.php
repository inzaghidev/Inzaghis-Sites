    ...
    <div class="navbar-wrapper container mx-auto max-w-screen-xl px-4 flex items-center justify-between gap-4 w-full">
      <div class="isites-logo flex items-center">
        <a href="<?php echo $pathToWebRoot.'/'; ?>" class="flex items-center py-5 px-2">
          <img src="<?php echo $pathToWebRoot.'/assets/icons/inzaghis-sites-logo-dengan-hut-ri-81.png'; ?>" title="Inzaghi&apos;s Sites | Dirgahayu Republik Indonesia! #81" class="!h-14" id="logo-nav" alt="Inzaghi's Sites">
        </a>
      </div>
      ...
      <div id="navigation-menu" :class="open ? 'block' : 'hidden'" class="nav-menu hidden lg:flex lg:flex-row flex-col items-center justify-start lg:space-x-1 pb-3 lg:pb-0 font-[Inter] text-sm">
        ...
        <div class="relative group" @mouseenter="dropdown = 'blogs'" @mouseleave="dropdown = null">
          ...
          >
            ...
            <a href="https://inzaghis-blog-aggregator.vercel.app" target="_blank" class="block px-4 py-2 mt-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none focus:shadow-outline">Inzaghi's Blog Aggregator</a>
          </div>
        </div>
        <div class="relative group" @mouseenter="dropdown = 'portals'" @mouseleave="dropdown = null">
          ...
          >
            ...
            <a href="<?php echo $pathToWebRoot.'/portals/career-portal.php'; ?>" class="block px-4 py-2 mt-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none focus:shadow-outline">Career Portal</a>
            <a href="<?php echo $pathToWebRoot.'/portals/learning-materials.php'; ?>" class="block px-4 py-2 mt-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none focus:shadow-outline">Learning Materials</a>
            <a href="<?php echo $pathToWebRoot.'/portals/entertainment-portal.php'; ?>" class="block px-4 py-2 mt-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none focus:shadow-outline">Entertainment Portal</a>
            ...
            <a href="<?php echo $pathToWebRoot.'/portals/muslim-portal.php'; ?>" class="block px-4 py-2 mt-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 md:mt-0 hover:text-gray-900 focus:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none focus:shadow-outline">Muslims Portal</a>
      ...
      <div class="flex items-center justify-between px-4 py-3 bg-gray-200">
        <span class="text-xl font-semibold text-gray-900">
          <a href="<?php echo $pathToWebRoot.'/'; ?>" class="relative bg-gray-200 w-auto max-w-full h-full px-2 py-2">
            <img src="<?php echo $pathToWebRoot.'/assets/icons/inzaghis-sites-logo-dengan-hut-ri-81.png'; ?>" title="Inzaghi&apos;s Sites | Dirgahayu Republik Indonesia! #81" class="!h-14" id="logo-nav" alt="Inzaghi's Sites"> </a></span>
        <div class="menu-toggle lg:hidden flex items-center hover:bg-gray-300 gap-2 rounded-lg block">
        ...
        <div class="mb-auto pt-4 p-[inherit] font-[Inter] text-sm">
          ...
          <div x-data="{ dropdownOpen: false }" class="relative pt-1">
            ...
            <div x-show="dropdownOpen" x-transition="" @click.away="dropdownOpen = false" class="nav-drpdwn-list w-full px-2 py-2 mt-2 mb-2 rounded-lg shadow-lg bg-[#dadeda] dark-mode:bg-[#222522]" style="display: none;">
              ...
              <a href="https://inzaghis-blog-aggregator.vercel.app" target="_blank" class="block px-4 py-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 hover:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none">Inzaghi's Blog Aggregator</a>
            </div>
          </div>
          <div x-data="{ dropdownOpen: false }" class="relative pt-1">
            <button @click="dropdownOpen = !dropdownOpen" class="w-full flex items-center justify-between gap-2 py-3 px-4 rounded-lg text-gray-900 hover:bg-[#c1e0d1] dark-mode:hover:bg-[#c1e0d1]">
            ...
            <div x-show="dropdownOpen" x-transition="" @click.away="dropdownOpen = false" class="nav-drpdwn-list w-full px-2 py-2 mt-2 mb-2 rounded-lg shadow-lg bg-[#dadeda] dark-mode:bg-[#222522]" style="display: none;">
              ...
              <a href="<?php echo $pathToWebRoot.'/portals/career-portal.php'; ?>" class="block px-4 py-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 hover:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none">Career Portal</a>
              <a href="<?php echo $pathToWebRoot.'/portals/learning-materials.php'; ?>" class="block px-4 py-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 hover:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none">Learning Materials</a>
              <a href="<?php echo $pathToWebRoot.'/portals/entertainment-portal.php'; ?>" class="block px-4 py-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 hover:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none">Entertainment Portal</a>
              ...
              <a href="<?php echo $pathToWebRoot.'/portals/muslim-portal.php'; ?>" class="block px-4 py-2 text-sm font-normal bg-transparent rounded-lg dark-mode:bg-transparent dark-mode:hover:bg-gray-600 dark-mode:focus:bg-gray-600 dark-mode:focus:text-white dark-mode:hover:text-gray-200 dark-mode:text-gray-200 hover:text-gray-900 hover:bg-white focus:bg-green-100 focus:outline-none">Muslims Portal</a>
