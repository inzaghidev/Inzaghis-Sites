<div class="nav-header" id="navHeader">
    <nav class="navbar" id="navbar">
        <a href="<?php echo $pathToWebRoot.'/public/index.php'; ?>" id="logo">
            <img src="<?php echo $pathToWebRoot.'/assets/icons/inzaghis-sites-logo-dengan-hut-ri-80.png'; ?>" title="Inzaghi&apos;s Sites | Dirgahayu Republik Indonesia! #80" height="60px" alt="logo" />
        </a>
