      ...
      <div class="page-container">
        ...
        <div class="page-wrapper bg-white shadow-xl rounded-lg ring-1 ring-green-500">
          <div class="page-description">
            ...
            <h2 class="text-3xl mb-6 font-semibold">Disclaimers for Inzaghi's Sites</h2>
            ...
            <p class="is-desc">
              ...
              (Inzaghi's Sites), is strictly at your own risk. Inzaghi's Sites
            ...
            <h2 class="text-3xl mb-6 font-semibold">Update</h2>
