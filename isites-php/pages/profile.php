            ...
            <div class="flex flex-col items-center">
              ...
              >
                <a
                  ...
                  target="_blank"
                  class="inline-flex w-full justify-center gap-x-1.5 py-3 px-3 min-w-[200px] rounded-lg bg-blue-500 hover:bg-blue-600 text-white hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300"
                  >Contact</a
                >
                <div
                  class="relative inline-flex min-w-[200px] w-full"
                  x-data="{ open: false }"
                ...
                >
                  ...
                  >
                    ...
                    <svg
                      ...
                      data-slot="icon"
                      aria-hidden="true"
                      class="-mr-1 size-5 text-gray-700 transition-transform duration-200"
                  ...
                  <div
                    ...
                    class="absolute left-0 right-0 top-full z-50 mt-1 rounded-lg bg-gray-100 shadow-xl outline outline-1 outline-black/5"
                    style="display: none;"
                  >
                    <div class="py-1">
                      <a
