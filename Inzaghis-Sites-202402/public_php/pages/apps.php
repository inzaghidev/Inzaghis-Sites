      ...
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
        <div class="card h-100 border-success shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary btn-md"><a href="../page-apps/pages.php" class="blog-link">Click here</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
        <div class="card h-100 border-success shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary btn-md"><a href="../page-apps/widgets.php" class="blog-link">Click here</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
        <div class="card h-100 border-success shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary btn-md"><a href="../page-apps/converter.php" class="blog-link">Click here</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
        <div class="card h-100 border-success shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="btn btn-primary btn-md"><a href="../page-apps/calculators.php" class="blog-link">Click here</a></button>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
